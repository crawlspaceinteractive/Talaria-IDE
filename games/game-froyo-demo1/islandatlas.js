...
import { loadGLBMeshIfAvailable } from "./geometry.js";

const MODEL_BASE_URL = "/models";

// ── Portal island URL (IslandF — exclusive to the portal platform) ────────────
const PORTAL_ISLAND_URL = `${MODEL_BASE_URL}/canyon_model.glb`;

// ── Child island URLs (A, B, C, D, E, G) ─────────────────────────────────────
const CHILD_ISLAND_URLS = [
  `${MODEL_BASE_URL}/island_A_model.glb`, // islandA
  `${MODEL_BASE_URL}/island_B_model.glb`, // islandB
  `${MODEL_BASE_URL}/island_C_model.glb`, // islandC
  `${MODEL_BASE_URL}/island_D_model.glb`, // islandD
  `${MODEL_BASE_URL}/island_E_model.glb`, // islandE
  `${MODEL_BASE_URL}/star+geometry+3d+model.glb`, // islandG
];
