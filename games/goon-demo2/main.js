...
import { MapGen, GEM_COLORS, GEM_WALL_IDS, GEM_KEY_ITEMS, rebakeBSP } from './mapgen.js';
import { EnemyManager } from './enemies.js';
import { Renderer, getModFont } from './renderer.js';
...
// ================== INTRO JINGLE ==================
const _introJingle = new Audio('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/c270b2e9-81e7-43d3-ad1f-ccf3ed675d76.mp3');
...
const intermissionBgImg = loadImg('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/1bf416c3-df0c-49fa-a9da-1dfdb63e3603.png');
...
async function initLevel(level) {
  ...
  for (const t of (map.torches || [])) {
    ...
    raycaster.attachSticker(
      t.wallX, t.wallY,
      t.x - t.normX * 0.4, t.y - t.normY * 0.4,   // world-space centre pushed toward wall face
...
function drawMinimap() {
  ...
  for (let y = 0; y < 20; y++) for (let x = 0; x < 20; x++) {
    ...
    if (mx < 0 || mx >= W || my < 0 || my >= H) mmCtx.fillStyle = '#111';
      ...
      if (cell === 1) {
        // Check if this is a closed toggleable (shows as wall on minimap)
        const tog = (map.toggleables||[]).find(t => t.x===mx && t.y===my);
        mmCtx.fillStyle = tog ? '#555' : '#555'; // toggleables disguise as walls
      }
...
function _buildMidiSection(container, idPrefix) {
  ...
  const MENU_GFX_MIDI = "url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/33483fc2-54a5-4b80-89b3-a1ff24d1700b.png')";
...
function _buildVolumeSection(container, idPrefix) {
  ...
  if (!document.getElementById('vol-slider-style')) {
    ...
    style.textContent = `
      ...
      .vol-slider::-webkit-slider-runnable-track { height:18px;border-image:url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/e5db7692-3c68-4250-af5e-f3cc5184dcf3.png') 0 33% 0 fill / 0 6px 0 / 0 stretch;border-style:solid;border-width:0 6px 0;background:transparent; }
      .vol-slider::-moz-range-track { height:18px;border-image:url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/e5db7692-3c68-4250-af5e-f3cc5184dcf3.png') 0 33% 0 fill / 0 6px 0 / 0 stretch;border-style:solid;border-width:0 6px 0;background:transparent; }
      .vol-slider::-webkit-slider-thumb { -webkit-appearance:none;width:20px;height:20px;margin-top:-1px;background:url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/646be7c3-6daf-42f3-beff-11122d370d24.png') center/contain no-repeat;background-color:transparent;border:none;cursor:pointer; }
      .vol-slider::-moz-range-thumb { width:20px;height:20px;background:url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/646be7c3-6daf-42f3-beff-11122d370d24.png') center/contain no-repeat;background-color:transparent;border:none;cursor:pointer;border-radius:0; }

      /* Pause-menu buttons — identical atlas style to main menu .btn */
      .pause-btn {
        --btn-atlas: url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/1524d820-8657-47fb-8bb6-1dd4b257b3d3.png');
        position: relative;
        display: inline-flex;
        align-items: center;
  ...
  const section = document.createElement('div');
  const MENU_GFX = "url('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/33483fc2-54a5-4b80-89b3-a1ff24d1700b.png')";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const _menuClickSfx = new Audio('https://vtelpopqybfytrgzkomj.supabase.co/storage/v1/object/public/game-assets/public/9f509457-a9ea-4f36-833c-dd820c597ef0/9c8633b2-9b38-4975-a64d-fd8c2caea308/4bbdd980-9366-49c0-a8af-efea6e84f6c2.mp3');
  ...
  // World contrast boost (no CRT overlay — applied directly to the game canvas)
  canvas.style.filter = 'contrast(1.25)';
