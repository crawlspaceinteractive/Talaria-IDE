var MidiPlayer = (function () {
  ...
  var Player = /*#__PURE__*/function () {
    function Player(eventHandler, buffer) {
      ...
      this.sampleRate = 8; // milliseconds
    ...
    _createClass(Player, [{
      ...
      value: function play() {
        ...
        if (!this.startTime) this.startTime = performance.now(); // Start play loop using drift-correcting setTimeout
      ...
      value: function schedulePlayLoop(delay) {
        ...
        this.setTimeoutId = setTimeout(function () {
          ...
          if (_this.setTimeoutId !== false) {
            ...
            while (now - _this.scheduledTime > _this.sampleRate) {
            ...
            var drift = now - _this.scheduledTime;
      ...
      value: function getCurrentTick() {
        ...
        var elapsedSeconds = (performance.now() - this.startTime) / 1000;
